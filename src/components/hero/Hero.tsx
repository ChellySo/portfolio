...
export const Hero = () => {
    return (
        <div className="max-w-screen-md h-full place-content-center flex flex-col xs:gap-6 gap-2 mx-auto w-full">
            <Typography variant="md/fushia">Hello, my name is</Typography>
            <div>
                <Heading variant="h1" className="!text-purple-200 2xs:text-heading-lg xs:text-heading-xl sm:text-heading-xxl">Chelly</Heading>
                <Heading variant="h2" className="2xs:text-heading-1 xs:text-heading-lg sm:text-heading-xl">Frontend Developer</Heading>
            </div>
