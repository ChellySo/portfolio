...
export const Experience = () => {
    return (
        <div className="max-w-screen-sm xs:min-h-screen place-content-center flex flex-col xs:gap-16 gap-12 mx-auto w-full my-0 xs:my-28">
